...
class ComplianceAgent:
    """Audit agent wrapper for compliance-related investigations."""
    ...
    def run(
        ...
        *,
        ...
        result["selected_agent"] = (routing_info or {}).get("agent", "compliance_agent")
...
if __name__ == "__main__":
    user_query = input("Enter compliance query: ")
    response = ComplianceAgent().run(user_query)
