...
class ApprovalAgent:
    """Audit agent wrapper for approval-related investigations."""
    ...
    def run(
        ...
        *,
        ...
        result["selected_agent"] = (routing_info or {}).get("agent", "approval_agent")
...
if __name__ == "__main__":
    user_query = input("Enter approval query: ")
    response = ApprovalAgent().run(user_query)
